...
def match():
    ...
    CallMatch.delay(output_prefix1, output_prefix2, output_path, keywords1, keywords2, species, cwd,
                    _CellLines, _CellTypes, _Organs, _Tissues, _inputEmail=_inputEmail)
...
def CallSearch(output_prefix, output_path, keywords, _Species, cwd,
               _CellLines, _CellTypes, _Organs, _Tissues,
               _inputEmail):

    result_df, samples = Search(output_prefix, output_path, keywords, _Species, cwd, _CellLines, _CellTypes, _Organs, _Tissues,
...
def CallMatch(output_prefix1, output_prefix2, output_path, keywords1, keywords2, species, cwd,
              _CellLines, _CellTypes, _Organs, _Tissues, _inputEmail):
    result_dfs = Match(output_prefix1, output_prefix2, output_path, keywords1, keywords2, species, cwd,
                       _CellLines, _CellTypes, _Organs, _Tissues, _inputEmail=_inputEmail)
